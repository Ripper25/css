...
const ConceptPhase: React.FC<ConceptPhaseProps> = ({
  projectId,
  onProgressUpdate
}) => {
...
## 1. Executive Summary
This concept note outlines the project which addresses ${content.problem?.content?.substring(0, 100)}...
